    ...
    <section id="cta2">
        <div class="container">
            <div class="text-center">
                <h2 class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms"><span>PELAYANAN</span> SURAT KETERANGAN <br> KAMPUNG JAMUR UJUNG</h2>
                <p class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="100ms">Klik Login untuk request pembuatan surat keterangan online
                    ...
                    <div class="col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="200ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                ...
                                <p>Setelah input data pemohon dengan lengkap dan benar, Pemohon memilih Surat yang mau direquest serta melengkapi data request, Kemudian Dikirim dan Menunggu persetujuan dari Reje.</p>
                            </div>
                        </div>
                    </div>
                    <!--/.col-md-4-->
                    ...
                    <div class="col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                ...
                                <p>Permohonan di setujui oleh Reje, kemudian admin akan mencetak surat sesuai request surat yang diajukan, pemohon mengambil surat yang sudah dicetak dan bertandatangan di Kantor Reje Kampung Jamur Ujung.</p>
                            </div>
                        </div>
                    </div>
                    <!--/.col-md-4-->
