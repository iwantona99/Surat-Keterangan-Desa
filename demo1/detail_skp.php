...
<?php
	if(isset($_GET['id_request_skp'])){
		...
		$sql = "SELECT * FROM data_request_skp natural join data_pemohon WHERE id_request_skp='$id_request_skp'";
										...
										<div class="col-md-6 col-lg-6">
												...
												<div class="col-md-6 col-lg-6">	
													<div class="form-group">
														...
														<input type="text" name="instansi" value="<?php echo $instansi;?>" class="form-control" placeholder="Telepon Anda..">
													</div>
													<div class="form-group">
														<label>Jabatan</label>
														<input type="text" name="jabatan" value="<?php echo $jabatan;?>" class="form-control" placeholder="Pekerjaan Anda.." >
													</div>	
													<div class="form-group">
													...
													<div class="form-group">
														<label>Ijin Berapa Lama</label>
														<input type="number" name="lama" value="<?php echo $lama;?>" class="form-control" placeholder="Telepon Anda.." >
													</div>
													<div class="form-group">
														<label>Sampai Tanggal</label>
														<input type="date" name="sampai_tanggal" value="<?php echo $sampai_tanggal;?>" class="form-control" placeholder="Telepon Anda..">
													</div>
												</div>
										</div>
									</div>
...
<?php
	if(isset($_POST['ubah'])){
		...
		keterangan='$keterangan', jabatan='$jabatan' WHERE id_request_skp='$id_request_skp'";
