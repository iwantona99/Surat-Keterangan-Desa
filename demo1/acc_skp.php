						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									...
									<h4 class="fw-bold text-uppercase">TAMPIL ACC REQUEST SURAT KETERANGAN MANDAH</h4>
									</div>
								</div>
								<div class="card-body">
								<form method="POST">
									<div class="table-responsive">
										<table id="add3" class="display table table-striped table-hover" >
											...
											<tbody>
                                                <?php
												$i=1;
                                                    $sql = "SELECT * FROM data_request_skp natural join data_pemohon where status=0";
