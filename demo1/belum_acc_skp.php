						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									...
									<h4 class="fw-bold text-uppercase"> tampil belum acc request surat keterangan mandah</h4>
									</div>
								</div>
									...
									<div class="card-body">
										<div class="table-responsive">
											<table id="add1" class="display table table-striped table-hover" >
												...
												<tbody>
													<?php
														$sql = "SELECT * FROM data_request_skp natural join data_pemohon where status=1";
